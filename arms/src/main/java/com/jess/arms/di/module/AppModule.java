...
//    @Singleton
    @Provides
    static ProgresDialog provideProgresDialog(AppManager appManager) {
        assert appManager.getTopActivity() != null;
        //noinspection unchecked
        return new ProgresDialog(appManager.getTopActivity());
    }
